    ...
    <div className="min-h-screen flex items-center justify-center bg-[#1D4E89] font-['Archivo'] px-4">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md space-y-6">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-2xl font-bold text-[#1D4E89]">Créer un compte</h2>
          <p className="text-gray-500 text-sm text-center">Veuillez remplir les champs ci-dessous pour vous inscrire</p>
        </div>
  ...
  <div className="space-y-1 pl-1">
    ...
    <Criterion label="Un caractère spécial" isValid={isValid.special} />
        ...
        <div className="text-center text-sm text-gray-500">
          Déjà inscrit ? <a href={`${BASE}login`} className="text-[#1D4E89] font-medium">Connexion</a>
        </div>
      </div>
    </div>
  );
